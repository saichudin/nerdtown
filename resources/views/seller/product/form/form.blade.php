...
<div class="form-group">
    <?php $seoHasErrors = Arr::has($errors->toArray(), ['ext_title', 'meta_description', 'meta_keywords']) ?>
    ...
    <div id="product-form-seo" class="collapse{{ $seoHasErrors ? ' show' : '' }}">
        <div class="callout">
            ...
            @include('seller.product.form.seo')
...
<div class="form-group">
    <?php $extraHasErrors = Arr::has($errors->toArray(), ['slug', 'excerpt']) ?>
    ...
    <div id="product-form-extra" class="collapse{{ $extraHasErrors ? ' show' : '' }}">
        <div class="callout">
            ...
            @include('seller.product.form.extra')
